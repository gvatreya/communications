...
GRANT ALL ON contact TO sc_test;
-- GRANT ALL ON contact_id_seq TO sc_test;
-- Alter statements
ALTER TABLE contact
    ADD CONSTRAINT pk_contact PRIMARY KEY (id);
ALTER TABLE contact
    ADD CONSTRAINT uq_contact_uuid UNIQUE (uuid);
ALTER TABLE contact
...
-- Grants
GRANT ALL ON channel TO sc_test;
-- Alter statements
ALTER TABLE channel
    ADD CONSTRAINT pk_channel PRIMARY KEY (id);
ALTER TABLE channel
    ADD CONSTRAINT uq_channel_name UNIQUE (name);
ALTER TABLE channel
    ADD CONSTRAINT uq_channel_uuid UNIQUE (uuid);
...
-- Grants
GRANT ALL ON message TO sc_test;
-- Alter statements
ALTER TABLE message
    ADD CONSTRAINT pk_message PRIMARY KEY (id);
ALTER TABLE message
    ADD CONSTRAINT uq_message_uuid UNIQUE (uuid);
ALTER TABLE message
